...
namespace EliteGym.Controllers
{
    ...
    public class ReservationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ReservationDate,MembershipId,FacilityId,ApplicationUserId")] Reservation reservation)
        {
            ...
            ViewBag.FacilityId = new SelectList(db.Facilities, "Id", "FacilityName", reservation.FacilityId);
            ViewBag.MembershipId = new SelectList(db.Memberships, "Id", "MembershipDuration", reservation.MembershipId);
            return View(reservation);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ReservationDate,MembershipId,FacilityId,ApplicationUserId")] Reservation reservation)
        {
            if (ModelState.IsValid)
            {
